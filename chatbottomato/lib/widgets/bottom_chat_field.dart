...
import 'package:chatbottomato/utility/animated_dialog.dart';
import 'package:chatbottomato/widgets/preview_images_widget.dart';
            ...
            children: [
              ...
              GestureDetector(
                onTap: widget.chatProvider.isLoading
                    ? null
                    : () {
                        if (textController.text.isNotEmpty || hasImages) {
                          // send the message
                          sendChatMessage(
                            message: textController.text,
                            chatProvider: widget.chatProvider,
